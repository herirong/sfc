			...
			<v-tab-item>
				<v-list-item>
					<v-list-item-avatar color="grey">
						<v-img :src="audioInfo.authors[0].avatar"></v-img>
					</v-list-item-avatar>
					<v-list-item-content>
				...
				<v-divider></v-divider>
				<audioPlayer v-on:getAudioIndex="getAudioIndex" :audioIndex="audioIndex" :autoPlay="true" :fileList="fileList"></audioPlayer>
				<v-list :disabled="false" :dense="false" :two-line="false" :three-line="false" :shaped="false" :flat="false" :subheader="false" :sub-group="false" :nav="false" :avatar="false" :rounded="true">
					...
					<v-list-item-group v-model="audioInfo" color="primary">
						<v-list-item v-for="(audioInfo, i) in audioInfoList" :key="i" :inactive="inactive">
							<!-- <v-list-item-avatar v-if="avatar">
								<v-img :src="audioInfo.avatar"></v-img>
							</v-list-item-avatar> -->
							<v-list-item-content>
								<v-list-item-title v-html="audioInfo.song_name+' —— '+audioInfo.author_name"></v-list-item-title>
							</v-list-item-content>
						</v-list-item>
					</v-list-item-group>
				</v-list>
